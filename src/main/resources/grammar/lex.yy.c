...
static yyconst short int yy_accept[46] =
    {   0,
        0,    0,   26,   24,    2,    1,   24,    7,    8,   15,
       13,   10,   14,   16,   12,   12,    9,   19,   17,   20,
       11,   11,   11,   11,   11,    5,    6,    2,   23,    3,
       12,   21,   18,   22,   11,   11,    4,   11,   11,    3,
       11,   11,   11,   11,    0
    } ;
...
static yyconst short int yy_base[48] =
    {   0,
        0,    0,   55,   56,   52,   56,   37,   56,   56,   56,
       56,   56,   56,   41,   56,   18,   56,   35,   34,   33,
        0,   25,   27,   25,   24,   56,   56,   42,   56,    0,
       20,   56,   56,   56,    0,   18,    0,   23,   19,    0,
       21,   15,   15,   18,   56,   32,   33
    } ;
...
static yyconst short int yy_nxt[86] =
    {   0,
       ...
       21,   23,   21,   21,   21,   24,   25,   26,   27,   31,
       31,   31,   31,   40,   35,   40,   37,   44,   37,   37,
       43,   42,   41,   28,   39,   38,   37,   36,   34,   33,
       32,   30,   29,   28,   45,    3,   45,   45,   45,   45,
       45,   45,   45,   45,   45,   45,   45,   45,   45,   45,
       45,   45,   45,   45,   45,   45,   45,   45,   45,   45,
       45,   45,   45,   45,   45
    } ;
...
static yyconst short int yy_chk[86] =
    {   0,
       ...
       16,   31,   31,   47,   46,   47,   44,   43,   42,   41,
       39,   38,   36,   28,   25,   24,   23,   22,   20,   19,
       18,   14,    7,    5,    3,   45,   45,   45,   45,   45,
       45,   45,   45,   45,   45,   45,   45,   45,   45,   45,
       45,   45,   45,   45,   45,   45,   45,   45,   45,   45,
       45,   45,   45,   45,   45
    } ;
...
YY_RULE_SETUP
#line 23 "new.lex"
{print_message(yytext,yytext,line_number,line_position);line_position+=yyleng;}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 24 "new.lex"
...
YY_RULE_SETUP
#line 31 "new.lex"
{int num_len = yyleng;if(num_len>0 && num_len<=10 && (num_len<10 || strcmp(yytext,"2147483648")<0)){print_message("NUM",yytext,line_number,line_position);line_position+=yyleng;}else{print_error("Number format error",line_number,line_position);exit(1);}}
	YY_BREAK
case 13:
YY_RULE_SETUP
#line 32 "new.lex"
